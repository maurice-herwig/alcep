...
class LarkOptions(Serialize):
    ...
    **=== End of Options ===**
    ...
    def __init__(self, options_dict: Dict[str, Any]) -> None:
        ...
        assert_config(self.parser, ('alcep', 'oalcep','earley', 'lalr', 'cyk', None))
...
class Lark(Serialize):
    ...
    def __init__(self, grammar: 'Union[Grammar, str, IO[str]]', **options) -> None:
        ...
        if self.options.ambiguity == 'auto':
            ...
            assert_config(self.options.parser, ('earley', 'cyk', 'alcep', 'oalcep'), "%r doesn't support disambiguation. Use one of these parsers instead: %s")
